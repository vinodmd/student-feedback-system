       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 9148600729
     </p>
           <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 9986350365
     </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:swasthikbhomkar@gmail.com">swasthikbhomkar@gmail.com</a>

                </p>
<p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:akshay007@gmail.com">akshay007@gmail.com</a>
