...
$q=mysqli_query($conn,"select * from faculty where email='$email'");
	...
	{	
	$result=	mysqli_query($conn,"insert into faculty(user_alias,Name,designation,programme,semester,email,password,mobile,date,status) values('$user_name','$name','$Designation','$prg','$sem','$email','$pass','$mob',now(),'0')");
